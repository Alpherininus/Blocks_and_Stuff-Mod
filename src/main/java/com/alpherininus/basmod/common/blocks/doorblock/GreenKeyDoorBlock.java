...
public class GreenKeyDoorBlock extends DoorBlock {
    ...
    public GreenKeyDoorBlock(AbstractBlock.Properties builder) {
        super(builder);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent("\u00A7aGreen Door Key"));
    }
}
