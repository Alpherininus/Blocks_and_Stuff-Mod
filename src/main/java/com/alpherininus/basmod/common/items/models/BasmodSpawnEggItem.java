...
public class BasmodSpawnEggItem  extends SpawnEggItem {
    protected static final List<BasmodSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public BasmodSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
