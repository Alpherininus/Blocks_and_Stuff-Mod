...
public class TrashbinTileEntity extends LockableLootTileEntity {
    ...
    private NonNullList<ItemStack> barrelContents = NonNullList.withSize(27, new ItemStack(Items.AIR));
    ...
    public void read(BlockState state, CompoundNBT nbt) {
        ...
        this.barrelContents = NonNullList.withSize(this.getSizeInventory(), new ItemStack(Items.AIR));
