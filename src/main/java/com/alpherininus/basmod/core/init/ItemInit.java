...
public class ItemInit {
    ...
    public static final RegistryObject<Item> EXPERIMENTAL_HORSE_ARMOR = ITEMS.register("experi_horse_armor",
            () -> new ExperiHorseArmorItem(9, "experi",
                    new Item.Properties().group(ModItemGroupWapons.BAS_MOD_WAPONS)));
    //
    public static final RegistryObject<Item> MODEL_HELMET = ITEMS.register("model_helmet",
            () -> new ArmorItem(BasmodArmorMaterial.MODELARMORS, EquipmentSlotType.HEAD,
                    new Item.Properties().group(ModItemGroupWapons.BAS_MOD_WAPONS)));

    public static final RegistryObject<Item> MODEL_CHESTPLATTE = ITEMS.register("model_chestplatte",
            () -> new ArmorItem(BasmodArmorMaterial.MODELARMORS, EquipmentSlotType.CHEST,
                    new Item.Properties().group(ModItemGroupWapons.BAS_MOD_WAPONS)));

    public static final RegistryObject<Item> MODEL_LEGGING = ITEMS.register("model_leggings",
            () -> new ArmorItem(BasmodArmorMaterial.MODELARMORS, EquipmentSlotType.LEGS,
                    new Item.Properties().group(ModItemGroupWapons.BAS_MOD_WAPONS)));

    public static final RegistryObject<Item> MODEL_BOOTS = ITEMS.register("model_boots",
            () -> new ArmorItem(BasmodArmorMaterial.MODELARMORS, EquipmentSlotType.FEET,
                    new Item.Properties().group(ModItemGroupWapons.BAS_MOD_WAPONS)));
