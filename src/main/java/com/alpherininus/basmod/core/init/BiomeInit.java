...
public class BiomeInit {
    ...
    private static Biome makeDarkForestBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float tiefe, float massstab) {
        ...
        DefaultBiomeFeatures.withSpawnsWithExtraChickens(mobspawninfoExtraChickens$builder);
        mobspawninfoExtraChickens$builder.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityTypesInit.BASMOD_WANDERINGTRADER.get(), 2, 0, 1));
        mobspawninfoExtraChickens$builder.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.CHICKEN, 4, 2, 2));
        ...
        mobspawninfoForMonster$builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.WITCH, 5, 1, 1));
        mobspawninfoForMonster$builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ILLUSIONER, 3, 1, 1));
        mobspawninfoForMonster$builder.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityTypesInit.BASMOD_WANDERINGTRADER.get(), 2, 1, 1));
        ...
        return (new Biome.Builder())
                ...
                .setEffects((new BiomeAmbience.Builder())
                        ...
                        .setMusic(BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_MENU))
                        .build())
                .withMobSpawnSettings(mobspawninfoExtraChickens$builder.build())
                .withMobSpawnSettings(mobspawninfoForCreature$builder.build())
                .withMobSpawnSettings(mobspawninfoForMonster$builder.build())
    ...
    private static Biome makeDarkPlainsBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float tiefe, float massstab) {
        ...
        DefaultBiomeFeatures.withSpawnsWithExtraChickens(mobspawninfoExtraChickens$builder);
        mobspawninfoExtraChickens$builder.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityTypesInit.BASMOD_BOSS_ENTITY.get(), 2, 0, 1));
        mobspawninfoExtraChickens$builder.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.CHICKEN, 4, 2, 2));
        ...
        mobspawninfoForMonster$builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.WITCH, 5, 1, 1));
        mobspawninfoForMonster$builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ILLUSIONER, 3, 1, 1));
        mobspawninfoForMonster$builder.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityTypesInit.BASMOD_BOSS_ENTITY.get(), 2, 1, 1));
        ...
        return (new Biome.Builder())
                ...
                .setEffects((new BiomeAmbience.Builder())
                        ...
                        .setMusic(BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_GAME))
                        .build())
                .withMobSpawnSettings(mobspawninfoExtraChickens$builder.build())
                .withMobSpawnSettings(mobspawninfoForCreature$builder.build())
                .withMobSpawnSettings(mobspawninfoForMonster$builder.build())
